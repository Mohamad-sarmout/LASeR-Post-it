...
const initstate = [
    ...
    {id:"3",title:"Food",Text:"Tomato,Potato,corn,Beef",date:"2023-1-10",color:"#a8896c",stylefont:"Open Sans"},
    {id:"4",title:"What is Redux?",Text:"Redux is a predictable state container designed to help you write JavaScript apps that behave consistently across client, server, and native environments, and are easy to test.",date:"2023-1-15",color:"#00c9b1",stylefont:"Open Sans"}
]
